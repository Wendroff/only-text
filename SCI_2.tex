...
In the present study, the stability of the boundary layer over airfoil NLF-0415 with -4$^\circ $ attack angle and 45$^\circ $ swept angle was analysed and the pressure gradient effect was investigated. The flow configuration was identical to the experiment conducted in Tsinghua University. Based on this case, the potential use of Dielectric-Barrier-Discharge (DBD) plasma actuators for transition delay was assessed by resolving the disturbance evolution with nonlinear parabolized stability equations (NPSE). Actuators were lined near the leading edge and generated electric wind perpendicular to the crossflow vortices' axes. The spanwise distances of neighbouring actuators was set to be the fundamental wavelength of the instability mode first. It was found that actuators only reduced the disturbance energy when the induced body force located at where the disturbance velocity had opposite direction. With wrong spanwise positions, the actuators even promoted the transition. The robustness was improved when put two actuators per fundamental wavelength. Several spanwise and streamwise locations of actuators were tested and all of them led to the reduction of the primary instability mode's energy which indicated the transition delay. Even in non-designed case, those actuators worked very well. Finally, a reverse control case was simulated and it revealed the mean flow distortion mode, namely the (0,0) mode, which could decrease the crossflow velocity played an important role in this control method.
\end{abstract}
