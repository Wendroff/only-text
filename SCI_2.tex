...
\affiliation{Tsinghua University, Beijing, P.R.China, 100084}
...
\centering
  ...
  \includegraphics[width=0.8\textwidth]{compare_UexpOUT_laminarcase}
...
\centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=0.8\textwidth]{compareCp_Reibert}
